...
This repository was forked from [Guipsamora's Pandas](https://github.com/guipsamora/pandas_exercises) Exercises project and repurposed to solve the same exercises using the Pyspark API instead of Pandas.


This repository contains 11 lessons covering core concepts in data manipulation :

- learning Pyspark 
- becoming familiar with the tools and functionality available in the API.
